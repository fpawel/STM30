...
type TopmostBar(parent) = 
    ...
    let buttonAccept = new Button( Parent = p, Height = textHeight14 + 10 )    
    let buttonCancel = new Button( Parent = p, Height = textHeight14 + 10 )
    

    let isVisible() =  safe p <| fun () -> p.Visible
