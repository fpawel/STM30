...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "СТМ-30-Цех-1"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\STM30app.exe"
...
OutFile "stm30-setup.exe"
InstallDir "$PROGRAMFILES\СТМ-30-Цех-1"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\СТМ-30-Цех-1.lnk" "$INSTDIR\STM30app.exe"
  CreateShortCut "$DESKTOP\СТМ-30-Цех-1.lnk" "$INSTDIR\STM30app.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\STM30app.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\STM30app.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\СТМ-30-Цех-1.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\СТМ-30-Цех-1.lnk"
